...
import {addStompClientAction} from "../actions/AddStompClientAction";
...
class ChatMessageBox extends Component {
  ...
  componentDidMount() {
    console.log("componentDidMount called")
      this.props.addStompClientAction();
      this.setState({
...
// mapDispatchToProps is called whenever mentioned action is called by props(see above)
//action calls the reducer to add or update the data of reducer
// then mapStateToProps is called to update the props
function mapDispatchToProps(dispatch) {
    console.log("called mapDispatchToProps")
    return bindActionCreators({
        addStompClientAction
    }, dispatch);
}
